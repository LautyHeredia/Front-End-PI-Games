         ...
         <form className="form" onSubmit={e => handleSubmit(e)}>
           <div className="formContainer">
            <div className="nameformInput">
               ...
               <p className="Genres_Name">Genres:</p>
               { <select onChange={e => handleGenreSelect(e)} className='Select_Genres'> {
                  genres.map(g => (
               ...
               { <select onChange={e => handlePlatformSelect(e)} className='Select_Platforms'> {
                  platforms.map(g => (
                     <option value={g.name}>{g.name}</option>
